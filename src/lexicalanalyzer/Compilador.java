...
public class Compilador {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        if(codigos.isEmpty()){
            System.out.println("Coloque os arquivos de teste na pasta de entrada");
            System.exit(0);
        }
        ...
        for(String codigo : codigos){
            ...
            System.out.println("Analise léxica concluída");
            if(analiseLexica.getListarErros().isEmpty()){
                System.out.println("Nao existem erros léxicos");
            }else{
